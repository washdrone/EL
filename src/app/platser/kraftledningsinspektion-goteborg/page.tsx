    ...
    <>
      ...
      <section className="section-padding bg-white">
        <div className="container-section">
          ...
          <div className="mt-10 sm:mt-12 grid gap-5 sm:gap-6 md:gap-8 md:grid-cols-3">
            {[
              {
              ...
              <Link
                key={item.title}
                href={item.href}
                className="card group text-center transition-all hover:border-brand-200 hover:shadow-md"
              >
