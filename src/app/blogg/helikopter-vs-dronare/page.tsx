      ...
      <article className="section-padding bg-white">
        <div className="content-article">
          ...
          <div className="mt-10 border-l-[3px] border-brand-500 bg-surface-50 p-6 sm:p-8">
            <h3 className="text-base font-semibold text-slate-900">Beräkna er besparing</h3>
            <p className="mt-2 text-sm leading-6 text-slate-600">
              Använd vår kostnadskalkylator för att beräkna den uppskattade
              kostnadsbesparingen för ert specifika scenario.
            </p>
            <Link href="/roi-kalkylator" className="mt-3 inline-flex items-center gap-1 text-sm font-medium text-brand-600 hover:text-brand-700">
