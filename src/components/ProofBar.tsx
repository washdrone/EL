...
export default function ProofBar() {
  return (
    <section className="border-b border-slate-100 bg-white">
      ...
      <div className="container-section py-10">
        <div className="grid grid-cols-2 gap-px bg-slate-100 sm:grid-cols-4">
          {capabilities.map((cap) => (
            <div key={cap.title} className="flex flex-col items-center bg-white p-6 text-center">
              <div className="flex h-11 w-11 items-center justify-center border border-brand-200 bg-brand-50">
      ...
      {/* Trust badges */}
      <div className="border-t border-slate-100 bg-surface-50/50">
        <div className="container-section py-5">
          <div className="flex flex-wrap items-center justify-center gap-x-8 gap-y-3">
            {trustBadges.map((badge) => (
              <div key={badge} className="flex items-center gap-2">
                <svg className="h-4 w-4 text-brand-600" fill="none" viewBox="0 0 24 24" stroke="currentColor" aria-hidden="true">
