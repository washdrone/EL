      ...
      <div className="container-section">
        <div className="mx-auto max-w-2xl text-center">
          ...
          <p className="body-text mt-4">
            Från planering till leverans – en strukturerad process som
          ...
          {steps.map((step, index) => (
            <div key={step.number} className="relative">
              ...
              {index < steps.length - 1 && (
                <div
                  className="absolute right-0 top-12 hidden h-0.5 w-full translate-x-1/2 bg-slate-200 lg:block"
                  aria-hidden="true"
                />
              )}
              ...
              <div className="relative flex flex-col items-center text-center lg:items-start lg:text-left">
                ...
                <span className="mt-4 text-xs font-bold uppercase tracking-widest text-accent-500">
                  Steg {step.number}
                </span>
