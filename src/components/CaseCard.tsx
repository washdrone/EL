...
export function CaseCard({ data }: CaseCardProps) {
  return (
    <article className="group border border-slate-200 bg-white p-6 transition-all duration-200 hover:border-brand-200 hover:shadow-card-hover">
      <div className="flex items-start gap-4">
        <div className="flex h-11 w-11 flex-shrink-0 items-center justify-center border border-brand-200 bg-brand-50 text-brand-600 transition-colors group-hover:bg-brand-100">
