...
export default function ComplianceModule() {
  return (
    <section className="section-padding bg-primary-600" id="compliance">
          ...
          {complianceItems.map((item) => (
            ...
            >
              <div className="flex items-start gap-4">
                <div className="flex h-10 w-10 flex-shrink-0 items-center justify-center rounded-md bg-white/20 text-white">
                  {item.icon}
                </div>
                <div>
